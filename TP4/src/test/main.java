...
import grafo.generadores.GeneradorAleatorioConProbabilidad;
import grafo.generadores.GeneradorGrafoNPartitos;
import grafo.generadores.GeneradorRegularConGrado;
import grafo.generadores.GeneradorRegularConPorcentaje;
...
public class main {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Test generador de grafo Aleatorio con Probabilidad: ");
		GeneradorAleatorioConProbabilidad.generar(5,60).escribirComoEntrada("testAlProb.in");
		System.out.println("Test generador de grafo Aleatorio con Porcentaje: ");
		GeneradorAleatorioConPorcentaje.generar(5,90).escribirComoEntrada("testAlConPorc.in");
		System.out.println("Test generador de Grafo N partito : ");
		GeneradorGrafoNPartitos.generar(5,2).escribirComoEntrada("testGrafoNPartito.in");
		...
		/***********PRUEBA COLOREO**************/
		System.out.println("probar algoritmo de coloreo: ");
		Grafo g = new Grafo(5);
		...
		g.escribirComoEntrada("testColoreo.in");
		
		GrafoNDNP ndnp = new GrafoNDNP("testColoreo.in");
		...
		ProgramaProbador pruebaColoreo= new ProgramaProbador("testColoreo.in","salidaSecuencial.out");
		if(pruebaColoreo.progProbador())
